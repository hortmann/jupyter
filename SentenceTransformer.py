...
class SentenceTransformer(nn.Sequential):
    ...
    ##########    HORST ###############################################
    # add function to return the autotokenizer Vocab HO
    def get_vocab(self,p):
    ...
    def add_tokens(self,new_tokens):
        mod_ext=self._first_module().add_tokenlist(new_tokens)
    ...
    def tokenize(self, text: str):
        ...
        Tokenizes the text
        """
       #print("self_first_module: ",self._first_module())
